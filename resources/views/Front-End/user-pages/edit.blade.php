        ...
        <div x-data="{tab:'profile'}" class="flex">
            <div class="col-span-3 cursor-pointer">
                ...
                <div class="flex p-4 mr-4 hover:bg-gray-200 hover:text-gray-600 hover:border-gray-700 hover:border-l"
                    :class="{'border-l border-gray-700' : tab ==='password'}" @click.prevent="tab='password'">
            ...
            <div class="col-span-7">
                ...
                <div x-show="tab ==='password'">
                    <form id="quickForm" class="block w-full px-5 py-5 ml-5 bg-white shadow-lg "
                        action="{{ url('/Store_Edit_Password/' . $username->id) }}" method="POST">
                        @csrf
                        <h3
                            class="pb-5 mb-2 font-mono text-2xl font-semibold text-center border-b-2 border-gray-400 cursor-pointer hover:text-gray-500">
                        ...
                        <div class="flex flex-wrap py-5 form-group">
                            <div class="w-full ">
                                <label for="exampleInputEmail1" class="mt-3 mb-3 mr-2 font-semibold text-gray-700 ">FUll
                                    Name :
                                </label>
                                <input type="text" name="f_name"
                                    class="w-full px-2 py-2 mt-2 mb-4 border border-gray-400 border-dotted rounded shadow-md form-control"
                                    id="full_name" disabled @if (empty($username->First_name) && empty($username->Last_name))
                            ...
                            <div class="w-full">
                                <label for="exampleInputEmail1" class="mt-3 mb-3 mr-2 font-semibold text-gray-700 ">User
                                    Name :
                                </label>
                                <input type="text" name="username"
                                    class="w-full px-2 py-2 mt-2 mb-4 border border-gray-400 border-dotted rounded shadow-md form-control"
                                    id="U_name" disabled required value="{{ $username->username }}">
                            </div>
                        </div>

                        <div class="w-full">
                            <label class="mt-5 mb-3 mr-2 font-semibold text-gray-700 ">Current Password
                                :</label>
                        ...
                        <div class="w-full">
                            <label class="mt-5 mb-3 mr-2 font-semibold text-gray-700 ">New Password
                                :</label>
                        ...
                        <div class="w-full">
                            <label class="mt-5 mb-3 mr-2 font-semibold text-gray-700 ">Confirm Password
                                :</label>
                ...
                <div x-show="tab ==='saved'">
                    <form id="quickForm" class="block w-full px-5 py-5 bg-white shadow-lg "
                        action="{{ url('/Store_Edit_avatar/' . $username->id) }}" method="POST"
                        ...
                        <div class="flex items-center justify-center">
                            <img src="{{ asset('user-style/user-images/' . $username->avatar) }}"
                                class="object-cover w-48 h-48 border-2 border-black rounded-full img-responsive">
                        </div>
                        <div class="flex flex-wrap mt-10 form-group">
                            <label class="w-full mt-5 mb-3 mr-2 font-semibold text-gray-700 ">Uplode Avatar
                                :</label>
                            <input type="file" name="avatar" class="w-full px-2 py-2 mb-4 rounded shadow-md form-control">
                            <input type="hidden" name="current_iamge" value="{{ $username->avatar }}">
