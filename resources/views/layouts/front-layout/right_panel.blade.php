    ...
    <div class="mt-2 ml-5 rounded shadow-lg max-h-xl">
        <div class="relative flex w-full px-3 py-3 bg-white" x-data="{isOpen:false }">
            ...
            <div class="absolute right-0 items-center float-left ">
                ...
                <ul class="absolute right-0 w-48 text-center capitalize bg-white rounded shadow-lg " x-show="isOpen"
        ...
        <img class="object-fill object-center w-full h-auto" src="{{ asset('admin-style/admin-images/IMG_1282.jpg') }}"
            alt="Dinner">
